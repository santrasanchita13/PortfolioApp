...
public class DesignDetailsPresenterTest {

    @Mock
    DesignDetailsMvpView view;
    ...
    private DesignDetailsPresenter<DesignDetailsMvpView> presenter;
    ...
    public void setUpSplashPresenter() {
        ...
        presenter = new DesignDetailsPresenter<>(dataManager, testSchedulerProvider, compositeDisposable);
    ...
    public void getDetailsData() {
        ...
        presenter.onViewAttached(bundle);
