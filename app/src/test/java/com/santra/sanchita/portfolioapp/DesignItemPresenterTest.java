...
public class DesignItemPresenterTest {

    @Mock
    DesignItemMvpView view;
    ...
    private DesignItemPresenter<DesignItemMvpView> presenter;
    ...
    public void setUpSplashPresenter() {
        ...
        presenter = new DesignItemPresenter<>(dataManager, testSchedulerProvider, compositeDisposable);
