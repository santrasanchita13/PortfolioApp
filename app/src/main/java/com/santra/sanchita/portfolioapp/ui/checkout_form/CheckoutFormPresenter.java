...
public class CheckoutFormPresenter<V extends CheckoutFormMvpView> extends BasePresenter<V> implements CheckoutFormMvpPresenter<V> {

    @Inject
    public CheckoutFormPresenter(DataManager dataManager,
