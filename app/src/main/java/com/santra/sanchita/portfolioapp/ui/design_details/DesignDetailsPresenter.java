...
public class DesignDetailsPresenter <V extends DesignDetailsMvpView> extends BasePresenter<V> implements DesignDetailsMvpPresenter<V> {

    @Inject
    public DesignDetailsPresenter(DataManager dataManager,
